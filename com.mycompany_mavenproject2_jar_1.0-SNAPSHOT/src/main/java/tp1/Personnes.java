...
public class Personnes {
    ...
    public Personnes(){
        ...
        this.liste.add(new Personne("emma.dossantos", "tototo", "Emma Dos Santos", "13 rue Bigard", "", "0612685102","0598612018"));
        this.liste.add(new Personne("kamal.aarab", "tatata", "Kamal Aarab", "14 rue Bigard", "", "0612685102","0598612018"));
    }
