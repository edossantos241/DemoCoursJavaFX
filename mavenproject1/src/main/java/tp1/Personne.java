...
public class Personne {
    ...
    private final StringProperty couleurYeux = new SimpleStringProperty();
    private final StringProperty couleurCheveux = new SimpleStringProperty();
    ...
    public String getAdresse1(){
        return adresse1.getValue();
    }
    
    public String getTel(){
        return tel1.getValue();
    }
    ...
    private String getYeux(){
        return couleurYeux.getValue();
    }
    
    private String getCheveux(){
    ...
    private StringProperty couleurYeuxProperty(){
        return couleurYeux;
    }

    private StringProperty couleurCheveuxProperty(){
